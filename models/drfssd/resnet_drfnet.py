...
from layers import *
import os
from models.drfssd.resnet_drfssd import DenseSSDResnet50, DenseSSDResnet101
...
def build_drf_res(cfg, phase, size=300, num_classes=21, channel_size="48", use_extra_prior=True):
