...
from layers import *
import os
from models.refine_drfssd.resnet_refine_drfssd import DenseSSDResnet101
...
class SSD(nn.Module):
    ...
    def __init__(self, cfg, phase, num_classes, size, channel_size='48'):
        ...
        self.extractor = DenseSSDResnet101(size)
    ...
    def load_weights(self, base_file):
        ...
        if ext == '.pkl' or '.pth':
            ...
            print("initing refine drf resnet ssd")
            ...
            self.extractor.smooth_list.apply(weights_init)
...
def build_refine_drf_res(cfg, phase, size=300, num_classes=21, channel_size="48",use_extra_prior=True):
